...
### چگونه استفاده کنیم؟
‫قالب پایان‌نامهٔ 'amirkabir-hw' در واقع یک بستهٔ قابل‌حمل است که بگونه‌ای طراحی شده تا مشخصات متغیر پایان‌نامه توسط دانشجو عوض شود و مطالب پایان‌نامه نیز توسط وی در فصول مختلف وارد گردد. به هیچ تلاشی برای قالب‌بندی نیاز نیست و تنها کافی است دانشجو طبق توضیحات، مطالب خود را وارد نماید.
...
### How to Use
'amirkabir-hw' latex template is a portable package, that is designed for customization by the student to fill his/her thesis materials.
...
## Screenshots
#### amirkabir-hw in BiDiTexmaker  
![biditexmaker](./img/biditexmaker.png "biditexmaker")

#### amirkabir-hw in BiDiTexmaker (draft mode)  
